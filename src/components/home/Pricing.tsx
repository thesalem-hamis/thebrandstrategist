          ...
          {pricingPlans.map((plan, index) => (
            ...
            >
              <div>
                ...
                {/* Bullet Features (Tick inside circle) */}
                <ul className="space-y-3.5 mb-8">
                  {plan.features.map((feature) => (
                    <li
                      key={feature}
                      className="flex items-center gap-3 text-xs sm:text-[13px] font-medium text-zinc-600 tracking-tight leading-tight"
                    >
                      <span className="flex h-4 w-4 shrink-0 items-center justify-center rounded-full bg-[#5D1F17] text-white">
              ...
              {/* Action Button (Pill button with arrow) */}
              <div className="pt-4">
                <a
                  href={plan.buttonLink || "#"}
                  className={`group inline-flex items-center justify-center gap-2 w-full font-bold text-xs py-3.5 px-6 rounded-full transition-all duration-300 ${
                    plan.highlighted
                      ? "bg-[#5D1F17] hover:bg-[#4A1812] text-white shadow-md"
                      : "bg-neutral-900 hover:bg-neutral-800 text-white"
                  }`}
                >
