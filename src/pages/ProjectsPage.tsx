            ...
            <article key={project.id} className="group flex flex-col w-full">
              ...
              >
                <div className="grid grid-cols-1 lg:grid-cols-12 divide-y lg:divide-y-0 lg:divide-x divide-neutral-200">
                  ...
                  {/* Main Hero Banner: sized to the image's own aspect ratio — nothing gets cropped */}
                  <div className="col-span-1 lg:col-span-8 xl:col-span-9 relative w-full overflow-hidden bg-neutral-900 flex items-center">
                    <img
                      src={project.bannerImage}
                  ...
                  {/* Right Mobile Frame: Desktop only, pinned to the bottom-right — no right/bottom margin */}
                  <div className="hidden lg:flex lg:col-span-4 xl:col-span-3 relative w-full bg-white pt-6 pl-6 pr-0 pb-0 justify-end items-end overflow-hidden">
                    <div className="relative w-full max-w-[300px] rounded-tl-[28px] sm:rounded-tl-[32px] rounded-bl-none rounded-r-none overflow-hidden shadow-2xl bg-neutral-950 transition-transform duration-700 ease-out group-hover:translate-y-0">
                      <img
