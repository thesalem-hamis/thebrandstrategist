...
const FALLBACK: Testimonial[] = [
  {
    ...
    quote: "Bimpe helped us clarify our brand and communicate our value so clearly. Our business has grown beyond what we imagined.",
  ...
  },
  {
    ...
    author: "Daniel Frost",
    role: "COO, Relay",
    quote: "Support was unreal. We went from mockup to production without friction.",
  ...
  },
  {
    ...
    quote: "Open, composable, and beautiful. Our engineers actually enjoy building with this.",
  ...
  },
  {
    ...
    quote: "This is the testimonial we feature everywhere. It captures why teams choose us.",
  ...
  },
  {
    ...
    quote: "The team adopted it overnight. The quality and execution are first-class.",
...
function TestimonialCard({ item }: { item: Testimonial }) {
  return (
    <div
      className={`w-[300px] sm:w-[380px] shrink-0 ${item.bgClass || "bg-white"} text-zinc-900 rounded-none p-6 sm:p-8 flex flex-col justify-between border-r border-b border-zinc-200/80 cursor-pointer transition-colors duration-200 hover:bg-zinc-50`}
    >
