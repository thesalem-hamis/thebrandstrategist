...
export const PRICING_TIERS: PricingTier[] = [
  ...
  {
    // IMPORTANT:
    // This ID MUST match public.services.id in Supabase.
    id: "personal-brand",
...
const FAQS = [
  {
    ...
    answer:
      "Most clients start with the consultation. It gives us both clarity on where you stand before committing to a larger engagement like Personal Brand Strategy or Brand Identity.",
  },
  {
  ...
  {
    question: "Can Personal Brand Strategy and Brand Identity be combined?",
    answer:
      "Yes. Many clients move from Personal Brand Strategy into Brand Identity once the positioning is locked in. Ask about bundled pricing on your call.",
  },
  {
      ...
      <div className="mx-auto max-w-7xl">
        ...
        >
          <p className="text-xs sm:text-sm leading-relaxed text-neutral-700 font-normal">
            Whether you need a focused strategy session, a strategic
            positioning framework, or a complete brand identity system
            there's a structured path forward. Each service is designed
            to deliver absolute clarity and actionable next steps,
        ...
        >
          ...
          <p className="text-xs sm:text-sm text-neutral-600 mb-10 max-w-xl mx-auto leading-relaxed">
            We've got the answers you need. Browse through our most
            asked questions to find quick, clear solutions.
          </p>
        ...
        >
          ...
          <p className="mt-3 max-w-xl text-xs sm:text-sm text-neutral-300 mx-auto leading-relaxed">
            Share a few details about your brand and goals, and
            we'll recommend the right path forward including
            budget-friendly options for early-stage teams.
          </p>
